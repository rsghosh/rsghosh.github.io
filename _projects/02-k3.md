...
{% endcapture %}
{% include elements/carousel-captioned.html images=carousel_images ride="carousel" interval="1000" caption="Toolhead Variants" %}
...
/assets/images/k3/front_door_engraving_steps/02_slices.png,2. Slices
/assets/images/k3/front_door_engraving_steps/03_slices_thickened.png, 3. Thickening slices
